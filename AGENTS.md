...
This is `google-analytics-gateway`, a Swift Package Manager project with mise-managed tools and tasks, Homebrew formula packaging, and optional signed Homebrew Cask packaging.
...
mise run test
mise run lint
swift run google-analytics-gateway --help
```
