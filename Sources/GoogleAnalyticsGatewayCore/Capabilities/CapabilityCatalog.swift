...
public enum CapabilityCatalog {
  ...
  public static let writerMutationFields: [String] = [
    "gaApproveDisplayVideo360AdvertiserLinkProposal",
    "gaArchiveAudience",
    "gaArchiveCustomDimension",
    "gaArchiveCustomMetric",
    "gaCancelDisplayVideo360AdvertiserLinkProposal",
    "gaCreateAdSenseLink",
    "gaCreateAudience",
    "gaCreateAudienceExport",
    "gaCreateAudienceList",
    "gaCreateBigQueryLink",
    "gaCreateCalculatedMetric",
    "gaCreateChannelGroup",
    "gaCreateConversionEvent",
    "gaCreateCustomDimension",
    "gaCreateCustomMetric",
    "gaCreateDataStream",
    "gaCreateDisplayVideo360AdvertiserLink",
    "gaCreateDisplayVideo360AdvertiserLinkProposal",
    "gaCreateEventCreateRule",
    "gaCreateEventEditRule",
    "gaCreateExpandedDataSet",
    "gaCreateFirebaseLink",
    "gaCreateGoogleAdsLink",
    "gaCreateKeyEvent",
    "gaCreateMeasurementProtocolSecret",
    "gaCreateProperty",
    "gaCreateRecurringAudienceList",
    "gaCreateReportTask",
    "gaCreateReportingDataAnnotation",
    "gaCreateRollupProperty",
    "gaCreateRollupPropertySourceLink",
    "gaCreateSKAdNetworkConversionValueSchema",
    "gaCreateSearchAds360Link",
    "gaCreateSubpropertyEventFilter",
    "gaProvisionSubproperty",
    "gaReorderEventEditRules",
    "gaUpdateAccount",
    "gaUpdateAttributionSettings",
    "gaUpdateAudience",
    "gaUpdateBigQueryLink",
    "gaUpdateCalculatedMetric",
    "gaUpdateChannelGroup",
    "gaUpdateConversionEvent",
    "gaUpdateCustomDimension",
    "gaUpdateCustomMetric",
    "gaUpdateDataRetentionSettings",
    "gaUpdateDataStream",
    "gaUpdateDisplayVideo360AdvertiserLink",
    "gaUpdateEnhancedMeasurementSettings",
    "gaUpdateEventCreateRule",
    "gaUpdateEventEditRule",
    "gaUpdateExpandedDataSet",
    "gaUpdateGoogleAdsLink",
    "gaUpdateGoogleSignalsSettings",
    "gaUpdateKeyEvent",
    "gaUpdateMeasurementProtocolSecret",
    "gaUpdateProperty",
    "gaUpdateReportingDataAnnotation",
    "gaUpdateReportingIdentitySettings",
    "gaUpdateSKAdNetworkConversionValueSchema",
    "gaUpdateSearchAds360Link",
    "gaUpdateStreamDataRedactionSettings",
    "gaUpdateSubpropertyEventFilter",
    "gaUpdateSubpropertySyncConfig",
  ...
  public static let adminMutationFields: [String] = [
    ...
    "gaBatchCreateAccountAccessBindings",
    "gaBatchCreatePropertyAccessBindings",
    "gaBatchDeleteAccountAccessBindings",
    "gaBatchDeletePropertyAccessBindings",
    "gaBatchUpdateAccountAccessBindings",
    "gaBatchUpdatePropertyAccessBindings",
    "gaCreateAccountAccessBinding",
    "gaCreatePropertyAccessBinding",
    "gaDeleteAccount",
    "gaDeleteAccountAccessBinding",
    "gaDeleteAdSenseLink",
    "gaDeleteBigQueryLink",
    "gaDeleteCalculatedMetric",
    "gaDeleteChannelGroup",
    "gaDeleteConversionEvent",
    "gaDeleteDataStream",
    "gaDeleteDisplayVideo360AdvertiserLink",
    "gaDeleteDisplayVideo360AdvertiserLinkProposal",
    "gaDeleteEventCreateRule",
    "gaDeleteEventEditRule",
    "gaDeleteExpandedDataSet",
    "gaDeleteFirebaseLink",
    "gaDeleteGoogleAdsLink",
    "gaDeleteKeyEvent",
    "gaDeleteMeasurementProtocolSecret",
    "gaDeleteProperty",
    "gaDeletePropertyAccessBinding",
    "gaDeleteReportingDataAnnotation",
    "gaDeleteRollupPropertySourceLink",
    "gaDeleteSKAdNetworkConversionValueSchema",
    "gaDeleteSearchAds360Link",
    "gaDeleteSubpropertyEventFilter",
    "gaProvisionAccountTicket",
    "gaSubmitUserDeletion",
    "gaUpdateAccountAccessBinding",
    "gaUpdatePropertyAccessBinding",
  ...
  public static let adminQueryFields: [String] = [
    "gaAccountAccessBinding",
    "gaAccountAccessBindings",
    "gaBatchGetAccountAccessBindings",
    "gaBatchGetPropertyAccessBindings",
    "gaPropertyAccessBinding",
    "gaPropertyAccessBindings",
    "gtmUserPermission",
    "gtmUserPermissions"
  ]
