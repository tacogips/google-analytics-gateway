...
///
/// Create, update, patch, delete, custom-verb POSTs such as `runReport` or
/// `publishVersion`, OAuth token exchange, and refresh rotation are all
/// excluded because none of them has a reviewed idempotency guarantee.
